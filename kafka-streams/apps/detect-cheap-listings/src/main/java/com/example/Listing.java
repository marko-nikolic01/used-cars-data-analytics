...
public class Listing {
    ...
    private String vin;
    private double percentageBelowAveragePrice;
    ...
    public Listing(String make, String model, int year, double price, String listingDate, String dealershipState, double longitude, double latitude, String vin) {
        ...
        this.vin = vin;
        this.percentageBelowAveragePrice = 0;
    }
    ...
    public double getPercentageBelowAveragePrice() { return percentageBelowAveragePrice; }

    public void setPercentageBelowAveragePrice(double percentageBelowAveragePrice) { this.percentageBelowAveragePrice = percentageBelowAveragePrice; }
}
