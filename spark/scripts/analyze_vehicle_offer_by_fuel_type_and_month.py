# /spark/bin/spark-submit --master spark://spark-master:7077 --packages org.mongodb.spark:mongo-spark-connector_2.12:10.5.0 /home/scripts/analyze_vehicle_offer_by_fuel_type_and_month.py
